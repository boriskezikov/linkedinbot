...
public enum TextConstants {
    ...
    HELP_MESSAGE("Команда /get_next_profiles позволяет получить рандомные профили из базы. Это удобно когда тебе надо быстро расширить свои коннекты!\n\n" +
    ...
    START_MESSAGE("Привет! Я бот, который поможет тебе обзавестить коннектами с участниками нашего сообщества в LinkedIn" +
            ...
            "\n\n- Команда /get_next_profiles позволяет получить рандомные профили из базы. Это удобно когда тебе надо быстро расширить свои коннекты " +
